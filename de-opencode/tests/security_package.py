...
def main() -> int:
    ...
    assert "Do not call `apply_patch`" in read("agents/data-engineer.md")
    assert "normal edit/write tooling" in read("agents/data-engineer.md")
    ...
    assert "Do not call `apply_patch`" in read("agents/data-devops.md")
    assert "edit: deny" in read("agents/data-architect.md")
    assert "Do not call `apply_patch`" in read("agents/data-architect.md")
