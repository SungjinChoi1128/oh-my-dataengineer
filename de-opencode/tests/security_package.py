...
def main() -> int:
    ...
    assert "Do not invoke patch/edit tools with an empty or placeholder payload" in read("agents/data-engineer.md")
    assert "at least one concrete change" in read("agents/data-engineer.md")
    ...
    assert "Do not invoke patch/edit tools with an empty or placeholder payload" in read("agents/data-devops.md")
    assert "edit: deny" in read("agents/data-architect.md")
    assert "Do not invoke patch/edit/write tools" in read("agents/data-architect.md")
    ...
    assert "cmd_hooks" in read("tools/de.py")
    assert "cmd_hooks" in read("tools/de_config.py")
    assert "plugin_origins" in read("tools/de_config.py")
    ...
    assert "de hooks" in read("README.md")
    ...
    assert "NoSetUserEnvironment" in read("install.ps1")
    assert "[Environment]::SetEnvironmentVariable(\"OPENCODE_CONFIG_DIR\"" in read("install.ps1")
    ...
    assert "de.py\") hooks" in read("smoke.ps1")
