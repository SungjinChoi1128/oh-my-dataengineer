...
Implementation agents use OpenCode's normal edit/write tooling for file changes and are explicitly instructed not to call `apply_patch` or patch-style tooling, avoiding empty-patch "Preparing patch..." stalls.
