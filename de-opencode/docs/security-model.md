...
- OpenCode permissions deny secret-file reads, allow normal code edits and todo-list updates for the primary implementation flow, and ask-gate raw deployment, SQL, and pipeline mutation commands.
...
1. OpenCode permissions allow code edits and todo-list updates while blocking or ask-gating risky tools.
